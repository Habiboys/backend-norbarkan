...
const (
	MovieSourceLocal    MovieSourceType = "local"
...
type Movie struct {
	...
	SourceType      MovieSourceType `json:"source_type" gorm:"type:enum('local','external');not null;index"`
	...
	TranscodeStatus TranscodeStatus `json:"transcode_status" gorm:"type:enum('pending','processing','done','failed');default:'pending'"`
